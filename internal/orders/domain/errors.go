...
var (
	...
	ErrOrderCancelled        = errors.New("batas waktu pembayaran telah habis, pesanan otomatis dibatalkan")
	...
	ErrRefundDeadlinePassed  = errors.New("pengajuan refund maksimal H-1 sebelum event dimulai")
